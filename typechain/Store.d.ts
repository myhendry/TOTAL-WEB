...
interface StoreInterface extends ethers.utils.Interface {
  functions: {
    "setTitle(string)": FunctionFragment;
  };

  encodeFunctionData(functionFragment: "setTitle", values: [string]): string;
...
export class Store extends BaseContract {
  ...
  callStatic: {
    setTitle(_title: string, overrides?: CallOverrides): Promise<void>;
  };
